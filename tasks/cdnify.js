...
function joinBaseAndPath(base, urlPath) {
  ...
  var fullPath = path.normalize("" + rest + path.sep + urlPath);
  // Avoid back-slashes generated by building from Windows platform.
  if (path.sep === '\\') fullPath = fullPath.replace(/\\/g, '/');
